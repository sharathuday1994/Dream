...
public class Register_Activity extends AppCompatActivity {
    ...
    public class UserRegisterTask extends AsyncTask <String,Void,String>{
        ...
        protected void onPostExecute(String result) {
            ...
            Dialog dialog = new Dialog(Register_Activity.this);
            dialog.setContentView(R.layout.register_success_dialog);
            dialog.setTitle(getString(R.string.register_success));
            TextView textView = (TextView) dialog.findViewById(R.id.register_dialog_text);
